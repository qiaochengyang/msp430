...
#define LCD_RST_H()		P1OUT |= BIT1;
#define LCD_RST_L()		P1OUT &=~BIT1;

#define LCD_RS_H()		P5OUT |= BIT2;
#define LCD_RS_L()		P5OUT &=~BIT2;


#define LCD_CS_H()		SPI_CS(1);
#define LCD_CS_L()		SPI_CS(0);
