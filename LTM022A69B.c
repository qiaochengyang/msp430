...
//	LCD_WRITE_COMMAND( 0x00d, 0x0018 );
  LCD_WRITE_COMMAND( 0x001, 0x0000 );
	LCD_WRITE_COMMAND( 0x002, 0x0000 );
	...
	LCD_WRITE_COMMAND( 0x009, 0x0000 );
	LCD_WRITE_COMMAND( 0x00b, 0x0000 );
	LCD_WRITE_COMMAND( 0x00c, 0x0100 );
	LCD_WRITE_COMMAND( 0x00d, 0x0018 );
                    ...
                    unsigned height)
{
	...
	LCD_WRITE_COMMAND( 0x212, x ); 	//x start point
	LCD_WRITE_COMMAND( 0x210, y ); 	//y start point
	LCD_WRITE_COMMAND( 0x213, x + width - 1 );	//x end point
	LCD_WRITE_COMMAND( 0x211, y + height - 1 );	//y end point
		
	LCD_WRITE_COMMAND( 0x201, x );
	LCD_WRITE_COMMAND( 0x200, y );
                        ...
                        unsigned char postion_y)
{
	...
	LCD_WRITE_COMMAND(0x212,postion_x*8); 	//x start point
	LCD_WRITE_COMMAND(0x210,postion_y*16); 	//y start point
	LCD_WRITE_COMMAND(0x213,postion_x*8+7);	//x end point
	LCD_WRITE_COMMAND(0x211,postion_y*16+15);	//y end point

	LCD_WRITE_COMMAND(0x201,postion_x*8);	//RAM X address(0 ~ FF, actually 0 ~ EF)	
	LCD_WRITE_COMMAND(0x200,postion_y*16);	//RAM Y address(0 ~ 1FF, actually 0 ~ 13F)
						...
						unsigned char postion_y )
{
	...
	LCD_WRITE_COMMAND(0x201,postion_x*8);	
	LCD_WRITE_COMMAND(0x200,postion_y*16);
                  ...
                  unsigned int y)
{
	...
	LCD_SEND_COMMAND(0x212,x);
	LCD_SEND_COMMAND(0x210,y);
	LCD_SEND_COMMAND(0x213,x+1);
	LCD_SEND_COMMAND(0x211,y+1);
	LCD_WRITE_COMMAND( 0x201, x );
	LCD_WRITE_COMMAND( 0x200, y );
...
void drawHeart(void)
{
  ...
  for(a=0;a<6.28;a+=0.01){
    ...
    x=p*cos(a)*40+210;
    y=150-p*sin(a)*40;
    lcd_draw_dot(BLACK,(int)x,(int)y);
  }
}